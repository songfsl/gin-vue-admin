...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/history/viewed-skus/{sku_id}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/product/{product_code}/coordinates": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "パラメータ不正、または商品コードが存在しない",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/api/v1/product/{product_code}/related": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/shipping-addresses/{address_id}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/productSkus/getTargetProductSkus": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.GetLoginTimeByUsersIdReq"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.AttributeInfo": {
            ...
            "properties": {
                ...
                "option_id": {
                    "description": "Value         *string ` + "`" + `json:\"value,omitempty\"` + "`" + `\nAttributeID   int     ` + "`" + `json:\"attribute_id\"` + "`" + `\nAttributeName string  ` + "`" + `json:\"attribute_name\"` + "`" + `",
                    "type": "integer"
                },
                "option_value": {
                    "type": "string"
        ...
        "dto.ProductInfo": {
            ...
            "properties": {
                ...
                "target_sku_info": {
                    "description": "CategoryName    string    ` + "`" + `json:\"category_name\"` + "`" + `\n// AttributeIDs    int                ` + "`" + `json:\"attribute_ids\"` + "`" + `",
                    "allOf": [
                        {
                            "$ref": "#/definitions/dto.TargetSKUInfo"
                        }
                    ]
                }
            }
        ...
        "dto.ProductVariantResponse": {
            ...
            "properties": {
                ...
                "variants": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.VariantOptionGroup"
                    }
                }
            }
        },
        ...
        "dto.TargetSKUInfo": {
            ...
            "properties": {
                "attributes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.AttributeInfo"
                    }
                },
                "price": {
        ...
        "dto.VariantOption": {
            ...
            "properties": {
                "linked_sku_ids": {
                    "description": "ImageURL     *string  ` + "`" + `json:\"image_url,omitempty\"` + "`" + `      // Swatch画像等\nIsSelectable bool     ` + "`" + `json:\"is_selectable\"` + "`" + `            // 在庫等による選択可否",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "dto.VariantOptionGroup": {
            ...
            "properties": {
                ...
                "options": {
                    "description": "DisplayType   string          ` + "`" + `json:\"display_type\"` + "`" + ` // 'image', 'text', etc.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.VariantOption"
                    }
                }
            }
        },
        ...
        "request.GetLoginTimeByUsersIdReq": {
            "type": "object",
            "properties": {
                "ID": {
                    "type": "integer"
